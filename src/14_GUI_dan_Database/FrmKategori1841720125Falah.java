...
public class FrmKategori1841720125Falah extends javax.swing.JFrame {

    public FrmKategori1841720125Falah() {
        initComponents();
        tampilkanDataFalah();
        kosongkanFormFalah();
    }
    ...
    public void tampilkanDataFalah()
    {
        ...
        ArrayList<Kategori1841720125Falah> list = new Kategori1841720125Falah().getAllFalah();
        Object rowData[] = new Object[3];
        
        tblKategori.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for (Kategori1841720125Falah kat : list) 
        {
            rowData[0] = kat.getIdkategoriFalah();
            rowData[1] = kat.getNamaFalah();
            rowData[2] = kat.getKeteranganFalah();
    ...
    {
        String[] kolom = {"idkategori", "nama", "keterangan"};
        ArrayList<Kategori1841720125Falah> list = new Kategori1841720125Falah().searchFalah(keyword);
        Object rowData[] = new Object[3];
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        kat.setIdkategoriFalah(Integer.parseInt(txtIdKategori.getText()));
        kat.setNamaFalah(txtNama.getText());
        kat.setKeteranganFalah(txtKeterangan.getText());
        kat.saveFalah();
        txtIdKategori.setText(Integer.toString(kat.getIdkategoriFalah()));
        tampilkanDataFalah();
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Kategori1841720125Falah kat = new Kategori1841720125Falah().getByIdFalah(Integer.parseInt(model.getValueAt(row, 0).toString()));
        kat.deleteFalah();
        kosongkanFormFalah();
        tampilkanDataFalah();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmKategori1841720125Falah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmKategori1841720125Falah().setVisible(true);
            }
        });
    }
