...
public class Kategori1841720125Falah {
    ...
    public ArrayList<Kategori1841720125Falah> getByNamaAndKeteranganFalah(String nama, String keterangan) {
        ArrayList<Kategori1841720125Falah> ListKategori = new ArrayList();
        ResultSet rs;
        if ((nama.trim().length() > 0) && (keterangan.trim().length() > 0)) {
            ...
            rs = DBHelper1841720125Falah.selectQueryFalah("SELECT * FROM kategori WHERE nama = '" + nama + "'");
        } else {
            rs = DBHelper1841720125Falah.selectQueryFalah(
                    "SELECT * FROM kategori "
