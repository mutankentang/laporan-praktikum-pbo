package pbojsempat;
public class Sapi1841720125Falah {
    private int berat,umur,harga;
    private String fisik;

    public Sapi1841720125Falah() {
    }

    public Sapi1841720125Falah(int berat, int umur, int harga, String fisik) {
        this.berat = berat;
        this.umur = umur;
        this.harga = harga;
        this.fisik = fisik;
    ...
    public void cetakSapiFalah(){
        System.out.println("--------------------------------------------------------------------------------");
        System.out.println("Anda Akaan Membeli Ternak Jenis Sapi dengan ketentuan Sebagai Berikut : "); 
